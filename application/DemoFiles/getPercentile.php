<h1> Search Percentile by Site or Year</h1>
...
if (isset($_POST['submit'])) {
    ...
    $query = "SELECT * FROM percentiles WHERE local_site_name = :local_site_name OR year = :year" ;
...
<?php foreach ($result as $row) { ?>
      ...
      <tr>
        ...
        <td><?php echo $row["ninety_nine_percentile"]; ?></td>
        <td><?php echo $row["ninety_eight_percentile"]; ?></td>
        <td><?php echo $row["ninety_five_percentile"]; ?></td>
        <td><?php echo $row["ninety_percentile"]; ?></td>
        <td><?php echo $row["seventy_five_percentile"]; ?></td>
        <td><?php echo $row["fifty_percentile"]; ?></td>
        <td><?php echo $row["ten_percentile"]; ?></td>
      </tr>
<?php } ?>
      </tbody>
  </table>
